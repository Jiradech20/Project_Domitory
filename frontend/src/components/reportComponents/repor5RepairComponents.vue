  ...
  <div class="container mt-4 fluid">
    <div class="card">
      <div class="card-header d-flex justify-content-between align-items-center">
        <h5>รายงานสรุปรายจ่ายในช่วงเวลา</h5>
        <div>
      ...
      <div class="card-body">
        ...
        <div v-if="activeTab === 'chart'" class="tab-content mt-3">
          ...
          <div v-else>
            ...
            <div class="row mb-3">
              <div class="col-md-12">
                <h6 class="text-center">จำนวนการสั่งซื้อวัสดุและอุปกรณ์ตามช่วงเวลา</h6>
  ...
  setup() {
    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get("/api/auth/getReport5", { params });
    ...
    const renderBarChart = (chartData) => {
      ...
      const chartTitle =
        filters.value.startDate && filters.value.endDate
          ? `ราคารวม (${filters.value.startDate} ถึง ${filters.value.endDate})`
          : "ราคารวมทั้งหมด";
    ...
    const fetchChartData = async () => {
      try {
        ...
        const response = await axios.get("/api/auth/fetchChartData5", {
          params: {
